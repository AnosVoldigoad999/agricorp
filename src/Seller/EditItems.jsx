...
export default function EditItems ({productName, 
    linkaddress, 
    quantity, 
    price, 
    setProductName,
    ...
    <main className='buyermain'>
      <form onSubmit={handleSubmit}>
       ...
       <div className='cats1'>
        ...
        {valid===false ?<button>Add</button>:productName.length===0?<button>Add</button>:linkaddress.length===0?<button>Add</button>:quantity.length===0?<button>Add</button>:price.length===0?<button>Add</button>:<Link to='/listings'><button>Add</button></Link>}
      </form>
    </main>
    </>
  }
